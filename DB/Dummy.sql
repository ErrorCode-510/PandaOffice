...
VALUES (201211001, '농합은행', '1234567890'),
       ...
       (201314004, '한국은행', '1234567893'),
       (201414005, '기읍은행', '1234567894'),
       (201515006, '기읍은행', '1234567895'),
       (201511007, '한하은행', '1234567896'),
       (201615008, '한하은행', '1234567897'),
       (201612009, '한국은행', '1234567898'),
       (201713010, '신항은행', '1234567899'),
       (201714011, '신항은행', '1234567900'),
       (201815012, '한국은행', '1234567901'),
       (201911013, '기읍은행', '1234567902'),
       (202012014, '한국은행', '1234567903'),
       (202113015, '신항은행', '1234567904'),
       (202114016, '농합은행', '1234567905'),
       (202215017, '한국은행', '1234567906'),
       (202311018, '한하은행', '1234567907'),
       (202312019, '기읍은행', '1234567908'),
       (202313020, '기읍은행', '1234567909'),
       (202314021, '신항은행', '1234567910'),
       (202411022, '신항은행', '1234567911'),
       (202412023, '한국은행', '1234567912'),
       (202413024, '기읍은행', '1234567913');
